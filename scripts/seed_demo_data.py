...
# Medications for hypertension and cardiovascular diseases
MEDICATIONS = [
    # ACE inhibitors
    ("Лізиноприл", "10 мг", "мг"),
    ("Еналаприл", "5 мг", "мг"),
    ...
    ("Квинаприл", "10 мг", "мг"),
    ("Фозиноприл", "10 мг", "мг"),
    ("Трандолаприл", "2 мг", "мг"),
    
    # ARBs (Angiotensin II receptor blockers)
    ("Лозартан", "50 мг", "мг"),
    ("Валсартан", "80 мг", "мг"),
    ("Кандесартан", "8 мг", "мг"),
    ("Ірбесартан", "150 мг", "мг"),
    ("Телмисартан", "40 мг", "мг"),
    ("Олмесартан", "20 мг", "мг"),
    ("Епросартан", "600 мг", "мг"),
    ("Азілсартан", "40 мг", "мг"),
    ...
    ("Бісопролол", "5 мг", "мг"),
    ("Атенолол", "25 мг", "мг"),
    ("Пропранолол", "40 мг", "мг"),
    ("Карведилол", "12.5 мг", "мг"),
    ("Небіволол", "5 мг", "мг"),
    ("Лабеталол", "100 мг", "мг"),
    ...
    ("Верапаміл", "80 мг", "мг"),
    ("Фелодипін", "5 мг", "мг"),
    ("Лерканідипін", "10 мг", "мг"),
    ("Нітрендипін", "20 мг", "мг"),
    
    # Diuretics
    ("Гідрохлортіазид", "12.5 мг", "мг"),
    ("Фуросемід", "40 мг", "мг"),
    ("Індапамід", "1.5 мг", "мг"),
    ("Спіронолактон", "25 мг", "мг"),
    ("Торасемід", "5 мг", "мг"),
    ("Хлорталідон", "25 мг", "мг"),
    ("Амілорид", "5 мг", "мг"),
    ...
    # Vasodilators
    ("Гідралазін", "25 мг", "мг"),
    ("Міноксидил", "2.5 мг", "мг"),
    ("Нітрогліцерин", "0.4 мг", "мг"),
    
    # Combination medications
    ("Лізиноприл + Гідрохлортіазид", "10/12.5 мг", "мг"),
    ("Валсартан + Гідрохлортіазид", "80/12.5 мг", "мг"),
    ("Амлодипін + Валсартан", "5/80 мг", "мг"),
    ("Амлодипін + Лізиноприл", "5/10 мг", "мг"),
    ("Еналаприл + Гідрохлортіазид", "10/25 мг", "мг"),
    
    # Antiplatelet agents
    ("Аспірин", "100 мг", "мг"),
    ("Клопідогрель", "75 мг", "мг"),
    ("Дипіридамол", "75 мг", "мг"),
    
    # Statins (lipid-lowering)
    ("Аторвастатин", "20 мг", "мг"),
    ("Симвастатин", "20 мг", "мг"),
    ("Розувастатин", "10 мг", "мг"),
    ("Правастатин", "40 мг", "мг"),
    
    # Other cardiovascular medications
    ("Дигоксин", "0.25 мг", "мг"),
    ("Амодарон", "200 мг", "мг"),
    ("Верапаміл SR", "180 мг", "мг"),
    ("Дилтіазем CD", "240 мг", "мг"),
]
...
def seed_medications() -> int:
    """Seed medications into the database."""
    with db_cursor() as cur:
        # Clear existing medications
        cur.execute("DELETE FROM medications")
        
        count = 0
        for name, dosage, unit in MEDICATIONS:
            cur.execute(
                """
                INSERT INTO medications (name, dosage, unit)
                VALUES (%s, %s, %s)
...
if __name__ == "__main__":
    # Seed medications first
    med_count = seed_medications()
    print(f"  ✅  Ліків додано: {med_count}")
    
    # Seed patient measurements
    for p in PATIENTS:
        n = seed_patient(p)
